...
class PublicSuffixList(BaseException):
	__instance = None

	def __init__(self, input_file=None):
		if PublicSuffixList.__instance:
			raise PublicSuffixList.__instance

		PublicSuffixList.__instance = self
		...
		if input_file is None:
			...
			input_file = codecs.open('analysis/public_suffix_list.dat', "r", "utf8")
